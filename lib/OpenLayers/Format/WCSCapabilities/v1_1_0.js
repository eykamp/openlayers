...
OpenLayers.Format.WCSCapabilities.v1_1_0 = OpenLayers.Class(
     ...
     * The two xxxesri namespaces below are required for parsing
     * non-compliant ArcGIS Server WCS that uses non-standard namespaces.
     */
    namespaces: {
     ...
     *     from the parent.
     *
     * NOTE: The ArcGIS Server WCS 1.1.0 GetCapabilities document is malformed,  
     *     so supportedFormat and available supportedCRS will be 'undefined'. 
     *     You can get this information from the DescribeCoverage document 
     *     instead.
     */
    readers: {
