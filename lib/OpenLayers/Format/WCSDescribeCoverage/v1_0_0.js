        ...
        "wcs": {
            ...
            "requestResponseCRSs" : function(node, supportedCRSs) {
             ...
             "supportedFormats": function(node, description) {
                if(!description.supportedFormat) {
                    description.supportedFormat = [];
                }
                this.readChildNodes(node, description.supportedFormat)
            },
            // There will be several of these within the supportedFormats tag
            "formats" : function(node, supportedFormat) {
                supportedFormat.push(this.getChildValue(node));
            },
        }, 
